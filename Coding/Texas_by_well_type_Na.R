...
#Do unit conversions 
#SW_WQP_Na_clean$DataValue[(SW_WQP_Na_clean$ResultMeasure.MeasureUnitCode %>% c("mg/l","mg/L","ppm"))] = 
#  SW_WQP_Na_clean$DataValue[(SW_WQP_Na_clean$ResultMeasure.MeasureUnitCode %>% c("mg/l","mg/L","ppm"))]*1000

#SW_WQP_Na_clean[(SW_WQP_Na_clean$ResultMeasure.MeasureUnitCode %>% c("mg/l","mg/L","ppm")),SW_WQP_Na_clean$DataValue] = 
#  SW_WQP_Na_clean[(SW_WQP_Na_clean$ResultMeasure.MeasureUnitCode %>% c("mg/l","mg/L","ppm")),SW_WQP_Na_clean$DataValue]*1000
  
#SW_WQP_Na_clean= replace(SW_WQP_Na_clean$DataValue, SW_WQP_Na_clean$ResultMeasure.MeasureUnitCode %>% c("mg/l","mg/L","ppm"), SW_WQP_Na_clean$DataValue*1000) 
#replace(df$Marks, df$Marks<0, 0) 
...
#   ggtitle("TX Surface Water Samples") +
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/sw_dist_nearest_marginal_Na.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# 
# sw.wq.distance_10km_no_0_1km = filter(sw.wq.distance_10km,num_well_1km>0)
# plot_gw_1km_density_well_all <- ggscatter(data=sw.wq.distance_10km_no_0_1km,
#                                           x="num_well_1km",
#                                           #x="num_og_1km",
#                                           y="daily_mean",
#                                           alpha = 0.5,
...
# ggsave("./output/AGU/Texas/figures/sw_1km_dens_marginal_Na.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
# plot_gw_3km_density_well_all <- ggscatter(data=sw.wq.distance_10km_no_0_3km,
#                                           #x="num_og_3km",
#                                           x="num_well_3km",
#                                           y="daily_mean",
#                                           alpha = 0.5,
...
# ggsave("./output/AGU/Texas/figures/sw_3km_dens_marginal_Na.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_SW_Na_marginal.rds", compress = FALSE)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/sw_dist_nearest_unconv_Na.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_1km = filter(sw.wq.distance_10km,num_well_1km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/sw_1km_dens_unconv_Na.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/sw_3km_dens_unconv_Na.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_SW_Na_unconv.rds", compress = FALSE)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/sw_dist_nearest_orphaned_Na.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_1km = filter(sw.wq.distance_10km,num_well_1km>0)
# table(sw.wq.distance_10km_no_0_1km$num_well_1km)
# plot_gw_1km_density_well_all <- ggscatter(data=sw.wq.distance_10km_no_0_1km,
#                                           x="num_well_1km",
#                                           y="daily_mean",
#                                           alpha = 0.5,
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/sw_1km_dens_orphaned_Na.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/sw_3km_dens_orphaned_Na.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_SW_Na_orphaned.rds", compress = FALSE)
...
orph.sites <- Texas_orphaned_clean[!duplicated(Texas_orphaned_clean[c("Longitude","Latitude")]),]
unconv.sites <- enverus_og_well_curated[!duplicated(enverus_og_well_curated[c("Longitude","Latitude")]),]
...
orph.all.coords <- SpatialPoints(orph.sites[,c("Longitude","Latitude")])
unconv.all.coords <- SpatialPoints(unconv.sites[,c("Longitude","Latitude")])

crs.geo<-CRS("+proj=longlat +ellps=WGS84 +datum=WGS84")
proj4string(sw.all.coords) <-crs.geo
proj4string(marg.all.coords) <-crs.geo
proj4string(orph.all.coords) <-crs.geo
proj4string(unconv.all.coords) <-crs.geo
...
orph.all.coords <- spTransform(orph.all.coords, CRS("+proj=eqdc +lat_0=0 +lon_0=0 +lat_1=33 +lat_2=45 +x_0=0 +y_0=0 +ellps=GRS80 +datum=NAD83 +units=m +no_defs"))
unconv.all.coords <- spTransform(unconv.all.coords, CRS("+proj=eqdc +lat_0=0 +lon_0=0 +lat_1=33 +lat_2=45 +x_0=0 +y_0=0 +ellps=GRS80 +datum=NAD83 +units=m +no_defs"))
...
## time-consuming step
#sw.nearest.well.all.date <- data.frame()
#for (i in 1:nrow(sw.nearest.well.all.index)) {
#  for (j in 1:(ncol(sw.nearest.well.all.index)-1)) {
#    sw.nearest.well.all.date[i,j] <- Well_data[sw.nearest.well.all.index[i,j],"SpudDate"]
#  }
#}
...
#Finds the first min value, in this case first value that is FALSE

As_is = as.data.frame(apply(sw.nearest.well.all.boolean, 1, which.max))
sw.nearest.well.all.boolean_1_0 = as.numeric(sw.nearest.well.all.boolean)
not_as_is = apply(as.numeric(sw.nearest.well.all.boolean), 1, which.max)
  
T_F_min = as.data.frame(apply(sw.nearest.well.all.boolean, 1, which.min))
T_F_try = as.data.frame(apply(sw.nearest.well.all.boolean, 1, which.min)+1)

nearest_well_index = 0
for (i in seq(1:dim(sw.nearest.well.all.boolean)[1])){
  nearest_well_index[i] = which.max(as.numeric(sw.nearest.well.all.boolean[i,]))
}

sw.nearest.well.all.boolean_FALSE <- as.data.frame(sw.wq.distance[,rep("Samplingdate",1000)] < sw.wq.distance[,a1:a2])
T_F_min_FALSE = as.data.frame(apply(sw.nearest.well.all.boolean_FALSE, 1, which.min))

sw.nearest.well.all.boolean_t1 <- as.data.frame((sw.wq.distance[,rep("Samplingdate",1000)] > sw.wq.distance[,a1:a2]))
T_F_num = as.data.frame(apply(sw.nearest.well.all.boolean_t1, 1, which.max(as.numeric)))


sw.nearest.well.all.boolean_t_t = as.integer(as.logical(sw.nearest.well.all.boolean_t1))

t1 = as.data.frame(sw.wq.distance[,rep("Samplingdate",1000)] < sw.wq.distance[,a1:a2])
t1["TRUE"] = 1
t1["FALSE"] = 0
...
sw.nearest.well.all.3km.boolean <- merge(data.frame(index=sw.wq.distance[,1]),
                                       ...
                                       all.x=TRUE)
sw.nearest.well.all.3km.boolean <- 
  select(sw.nearest.well.all.3km.boolean,-index) * select(sw.nearest.well.all.boolean,-nearest_well_index)
...
sw.wq.distance$num_well_1km <- rowSums(sw.nearest.well.all.1km.boolean)
sw.wq.distance$num_well_3km <- rowSums(sw.nearest.well.all.3km.boolean)


saveRDS(sw.wq.distance,file = "./output/Texas_SW_SC_nearest_well_marginal.rds", compress = FALSE)

source("Well_spatial_analysis.R")
#Make sure spud name is "SpudDate"
sw.wq.distance2 = Well_spatial_analysis(Texas_marginal_short,SW_Na_Texas_merged)
...
#remove rows with nearest_distance_m >10000 m
sw.wq.distance_10km_2 <- sw.wq.distance2 %>%
  filter(nearest_distance_m < 10000)

#plot distance vs. mean concentration
plot_gw_dist_nearest_ow_all <- ggscatter(data=sw.wq.distance_10km_2,
                                         x="nearest_distance_m",
                                         y="daily_mean",
                                         add = "loess",
                                         add.params = list(color="blue",fill="lightgray"),
...
plot_gw_1km_density_well_all <- ggscatter(data=sw.wq.distance_10km,
                                         x="num_well_1km",
                                         y="daily_mean",
                                         add = "reg.line",
                                         add.params = list(color="blue",fill="lightgray"),
...
plot_gw_3km_density_well_all <- ggscatter(data=sw.wq.distance_10km,
                                          x="num_well_3km",
                                          y="daily_mean",
                                          add = "reg.line",
                                          add.params = list(color="blue",fill="lightgray"),
...
chk = data.frame(sw.wq.distance_10km$num_well_3km,sw.wq.distance_10km$daily_mean,sw.wq.distance_10km$nearest_distance_m)
...
saveRDS(sw.wq.distance,file = "./output/Texas_SW_SC_nearest_well_unconv.rds", compress = FALSE)
...
saveRDS(sw.wq.distance,file = "./output/Texas_SW_SC_nearest_well_orph.rds", compress = FALSE)
'''
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/gw_dist_nearest_marginal_Na.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# 
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_1km_dens_marginal_Na.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_3km_dens_marginal_Na.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #check GW data distribution
# GW_Na_Texas_merged_org = GW_Na_Texas_merged %>%
#   arrange(daily_mean)
# hist(GW_Na_Texas_merged$daily_mean)
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_GW_Na_marginal.rds", compress = FALSE)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/gw_dist_nearest_unconv_Na.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_1km = filter(sw.wq.distance_10km,num_well_1km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_1km_dens_unconv_Na.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_3km_dens_unconv_Na.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_GW_Na_unconv.rds", compress = FALSE)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/gw_dist_nearest_orphaned_Na.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_1km = filter(sw.wq.distance_10km,num_well_1km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_1km_dens_orphaned_Na.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_3km_dens_orphaned_Na.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_GW_Na_orphaned.rds", compress = FALSE)
# 
# 
# 
# 
...
# sw.wq.sites <- GW_Na_Texas_merged[!duplicated(GW_SC_Texas_merged[c("Longitude","Latitude")]),]
# 
# # convert to spatial dataset
# sw.all.coords <- SpatialPoints(sw.wq.sites[,c("Longitude","Latitude")])
# 
