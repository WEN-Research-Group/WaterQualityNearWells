...
#MARGINAL
#sw.wq.distance = Well_spatial_analysis_comp(Texas_marginal_short,SW_SC_Texas_merged)

sw.wq.distance = Well_spatial_analysis_compl_0127(Texas_marginal_short,SW_SC_Texas_merged)
#Save analysis results
#saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_SW_SC_marginal.rds", compress = FALSE)
...
# ggsave("./output/AGU/Texas/figures/sw_dist_nearest_marginal_SC.png",
...
# 
# sw.wq.distance_10km_no_0 = filter(sw.wq.distance_10km,num_og_1km>0)
# plot_gw_1km_density_well_all <- ggscatter(data=sw.wq.distance_10km_no_0,
#                                           #x="num_well_1km",
#                                           x="num_og_1km",
#                                           y="daily_mean",
#                                           alpha = 0.5,
...
# plot_gw_1km_density_well_all
# 
# ggsave("./output/AGU/Texas/figures/sw_1km_dens_marginal_SC.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_og_3km>0)
...
# ggsave("./output/AGU/Texas/figures/sw_3km_dens_marginal_SC.png",
...
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_SW_SC_unconv.rds", compress = FALSE)
# 
# 
# # remove rows with nearest_distance_m >10000 m
# sw.wq.distance_10km <- sw.wq.distance %>%
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/sw_dist_nearest_unconv_SC.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/sw_1km_dens_unconv_SC.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/sw_3km_dens_unconv_SC.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/sw_dist_nearest_orphaned_SC.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_1km = filter(sw.wq.distance_10km,num_well_1km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/sw_1km_dens_orphaned_SC.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/sw_3km_dens_orphaned_SC.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_SW_SC_orphaned.rds", compress = FALSE)
# 
# #What if we look at the correlation between high SC concentration and wells?
# #keep only samples that are higher than the mean
# sw.wq.distance_10km_high = filter(sw.wq.distance_10km, daily_mean > mean(sw.wq.distance_10km$daily_mean))
# plot_gw_dist_nearest_ow_all_high <- ggscatter(data=sw.wq.distance_10km_high,
#                                          x="nearest_distance_m",
#                                          y="daily_mean",
#                                          alpha = 0.5,
#                                          add = "loess",
...
#   ggtitle("TX Surface Water Samples") +
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all_high
# 
# plot_gw_dist_nearest_ow_all_high_sp <- ggscatter(data=sw.wq.distance_10km_high,
#                                               x="nearest_distance_m",
#                                               y="daily_mean",
#                                               alpha = 0.5,
#                                               add = "loess",
...
#   ggtitle("TX Surface Water Samples") +
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all_high_sp


#What if I pick only samples that came from places that have high well density within 3 km radius?




'''
#Or do it step by step (double check)
...
sw.wq.sites <- SW_SC_Texas_merged[!duplicated(SW_SC_Texas_merged[c("Longitude","Latitude")]),]
...
sw.wq.distance <- merge(SW_SC_Texas_merged, sw.wq.sites[,c("Latitude","Longitude","index")],                        
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/gw_dist_nearest_marginal_SC.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# 
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_1km_dens_marginal_SC.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_3km_dens_marginal_SC.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_GW_SC_marginal.rds", compress = FALSE)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/gw_dist_nearest_unconv_SC.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_1km = filter(sw.wq.distance_10km,num_well_1km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_1km_dens_unconv_SC.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_3km_dens_unconv_SC.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_GW_SC_unconv.rds", compress = FALSE)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_dist_nearest_ow_all
# ggsave("./output/AGU/Texas/figures/gw_dist_nearest_orphaned_SC.png",
#        plot = plot_gw_dist_nearest_ow_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_1km = filter(sw.wq.distance_10km,num_well_1km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_1km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_1km_dens_orphaned_SC.png",
#        plot = plot_gw_1km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# sw.wq.distance_10km_no_0_3km = filter(sw.wq.distance_10km,num_well_3km>0)
...
#   theme_bw() +  theme(text = element_text(size = 16))
# plot_gw_3km_density_well_all
# ggsave("./output/AGU/Texas/figures/gw_3km_dens_orphaned_SC.png",
#        plot = plot_gw_3km_density_well_all,
#        width = 8, height = 6, units = "in")
# 
# #Save analysis results
# saveRDS(sw.wq.distance,file = "./output/AGU/Texas/Texas_GW_SC_orphaned.rds", compress = FALSE)
# 
